...
import { CreatedEntry } from '@/components/NewEntryDialog';
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 transition-colors py-12">
      ...
      <div className="max-w-3xl mx-auto px-6">
        {/* Search Section */}
        <div className={`${showResults ? 'mb-12' : 'min-h-[60vh] flex flex-col justify-center'} transition-all`}>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-16 pr-6 py-5 rounded-full bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500 shadow-lg dark:shadow-2xl outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-600 transition-all"
            />
          </div>
        </div>
        ...
        {showResults && (
          <div>
            <h2 className="mb-4 text-gray-900 dark:text-white">
              {useSemanticSearch ? 'AI Search Results' : 'Entries List'}
            </h2>
              ...
              {displayEntries.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white rounded-full transition-colors shadow-lg hover:shadow-xl"
                  >
